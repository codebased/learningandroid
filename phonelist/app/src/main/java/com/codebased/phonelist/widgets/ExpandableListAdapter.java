...
public class ExpandableListAdapter<Header, Item> extends BaseExpandableListAdapter {

    private Context _context;
    private List<Header> _listDataHeader; // header titles
    // child data in format of header title, child title
    private Map<Header, List<Item>> _listDataChild;

    public ExpandableListAdapter(Context context, List<Header> listDataHeader,
                                 Map<Header, List<Item>> listChildData) {
